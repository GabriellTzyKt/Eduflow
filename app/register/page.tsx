        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              {/* Tambahkan class relative pada wrapper input agar icon bisa diposisikan absolute */}
              <div className="mt-2 relative">
                <input
                  id="password"
                  // 3. Ubah type berdasarkan state showPassword
                  ...
                  disabled={isLoading}
                  // Tambahkan padding-right (pr-10) agar teks tidak menabrak icon mata
            ...
            {/* Input Confirm Password (Modified) */}
            <div>
              <label
              ...
              <div className="mt-2 relative">
                <input
                  id="confirm-password"
                  // 5. Ubah type berdasarkan state showConfirmPassword
                ...
                {/* 6. Tombol Toggle Confirm Password */}
                <button
                  type="button"
