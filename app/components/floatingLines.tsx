  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none p-8">
        {/*
           Kita gunakan pointer-events-none pada container utama agar mouse tetap bisa
           menembus ke canvas di belakangnya (untuk efek interaktif gelombang).
           Tapi, kita harus mengaktifkan kembali pointer-events pada konten sebenarnya
           agar tombol/link bisa diklik.
         */}
